...
red_space_ship = pygame.image.load(os.path.join(current_dir, "elements", "enemy1.png"))
green_space_ship = pygame.image.load(os.path.join(current_dir, "elements", "enemy2.png"))
blue_space_ship = pygame.image.load(os.path.join(current_dir, "elements", "enemy3.png"))

yellow_space_ship = pygame.image.load(os.path.join(current_dir, "elements", "white ship final (1).png"))


laser_red = pygame.image.load(os.path.join(current_dir, "elements", "pixel_laser_red.png"))
laser_blue = pygame.image.load(os.path.join(current_dir, "elements", "pixel_laser_blue.png"))
laser_green = pygame.image.load(os.path.join(current_dir, "elements", "pixel_laser_green.png"))
laser_yellow = pygame.image.load(os.path.join(current_dir, "elements", "pixel_laser_yellow.png"))


mixer.music.load(os.path.join(current_dir, "elements", "bgmusic.ogg"))
mixer.music.play(-1)


back = pygame.image.load(os.path.join(current_dir, "elements", "space(5).png"))
